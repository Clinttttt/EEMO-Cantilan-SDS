...
public class GetMobileTrmCollectionQueryHandlerTests
{
        ...
        CollectorUser? collector, Guid? collectorId)
    {
        ...
        return (new GetMobileTrmCollectionQueryHandler(collectorRepo.Object, trmRepo.Object, suggestionRepo.Object, CacheTestDoubles.FeeRateResolver, currentUser.Object, new FixedClock(DateTime.UtcNow)), trmRepo);
    }

    private static CollectorUser CollectorWith(params FacilityCode[] codes)
    {
        var collector = CollectorUser.Create("Tonyo", "EEMO-2026-005", "tonyo", "tonyo@eemo.gov", "0917", TestPasswords.Hash("Secret123!"));
