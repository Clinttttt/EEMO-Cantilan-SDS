...
public class GetMobileTpmCollectionQueryHandlerTests
{
        ...
        CollectorUser? collector, Guid? collectorId)
    {
        ...
        return (new GetMobileTpmCollectionQueryHandler(collectorRepo.Object, tpmRepo.Object, suggestionRepo.Object, CacheTestDoubles.FeeRateResolver, CacheTestDoubles.TpmMarketDay, currentUser.Object, new FixedClock(DateTime.UtcNow)), tpmRepo);
    }

    private static CollectorUser CollectorWith(params FacilityCode[] codes)
    {
        var collector = CollectorUser.Create("Nena", "EEMO-2026-007", "nena", "nena@eemo.gov", "0917", TestPasswords.Hash("Secret123!"));
