...
`docs/` (the permanent tool-neutral project knowledge base), `.agents/skills/` (StallTrack-specific procedural skills),
`AGENTS.md` (coding-agent entry point), `mobile-app-site/` (the static site behind the APK download and bind links — **written to by
...
- Canonical knowledge: `docs/`; procedural agent workflows: `.agents/skills/`; concise agent entry point: `AGENTS.md`.
