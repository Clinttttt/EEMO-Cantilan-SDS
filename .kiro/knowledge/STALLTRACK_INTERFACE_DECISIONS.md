...
**Architecture:** [STALLTRACK_INTERFACE_ARCHITECTURE.md](STALLTRACK_INTERFACE_ARCHITECTURE.md)
**Migration:** [STALLTRACK_INTERFACE_MIGRATION_PLAN.md](STALLTRACK_INTERFACE_MIGRATION_PLAN.md)
...
Two existing-document statements require explicit reconciliation at the baseline:

1. [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md) names the target landing workspace `Dashboard`. The current interface architecture ruling names it `Overview`. This registry treats Overview as the target interface label while preserving the same portfolio-summary purpose. This is an interface wording refinement, not a financial/domain change.
2. The revenue architecture still describes the one-month delinquency runtime transition as future in its Phase 5B status. Baseline code and tests already set `DomainRules.DelinquentThresholdMonths = 1`, report every account with at least one fully elapsed unpaid month as delinquent, leave Arrears unset, and use three months only for urgency. The phase-status wording is stale for delinquency runtime behavior. Its unresolved Arrears boundary remains current.

The existing canonical files are not edited by this documentation task. A later documentation-only change should reconcile those two statements and link to the interface documents.
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), sections 3, 7, 12, and 13; baseline code and migrations.
...
- **EVIDENCE / SOURCE:** Current interface architecture ruling; [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), section 10, with the Dashboard-to-Overview label refinement recorded in IA-003.
...
- **EVIDENCE / SOURCE:** Current interface architecture ruling; earlier target label in [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), section 10.
...
- **EVIDENCE / SOURCE:** Current route/sidebar audit; target facility architecture in [STALLTRACK_INTERFACE_ARCHITECTURE.md](STALLTRACK_INTERFACE_ARCHITECTURE.md).
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), sections 3, 4, and 7; [arch-rules.md](arch-rules.md), money rules.
...
- **EVIDENCE / SOURCE:** Current audit of Collection Manager, Follow-up, Whole-time History, and Closed Accounts; reporting model in [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), section 8.
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), section 10; target account model.
...
- **EVIDENCE / SOURCE:** [arch-rules.md](arch-rules.md), money rules; `StallOccupancy.AnsweringForMonth`; current Stall Profile and closed-account behavior.
...
- **EVIDENCE / SOURCE:** Current Sidebar locked Collectors/Audit rows; role rules in [EEMO_Complete_Documentation.md](EEMO_Complete_Documentation.md), section 4.
...
- **EVIDENCE / SOURCE:** Current Mobile route and archetype audit; approved task-focused Mobile rule in [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), section 11.
...
- **EVIDENCE / SOURCE:** Current Web route inventory; [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), section 10.
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), target components and phases 3/6.
...
- **EVIDENCE / SOURCE:** Current interface architecture ruling; retired remittance history in [OUTSTANDING_WORK.md](OUTSTANDING_WORK.md); prohibition against resurrecting the partial workflow in [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), section 4.
...
- **EVIDENCE / SOURCE:** Current explicit ruling; [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), sections 4 and 14; current reports intentionally leave Arrears unset.
...
- **EVIDENCE / SOURCE:** Current `OnlinePayments.razor`; role rules in [EEMO_Complete_Documentation.md](EEMO_Complete_Documentation.md).
...
- **EVIDENCE / SOURCE:** Tenant-resolution rule in [arch-rules.md](arch-rules.md); current Web/Mobile headers.
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), sections 4, 12, 13, and 14.
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), confirmed WCF target entry requirement.
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), phases 3 and 13 current status.
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), phases 6 and 14 decision gates.
...
- **EVIDENCE / SOURCE:** [arch-rules.md](arch-rules.md), money/reporting rules; [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), section 8.
...
- **EVIDENCE / SOURCE:** [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md), monthly-obligation ruling; NPM specialization.
...
- **EVIDENCE / SOURCE:** Audit recommendation re-evaluated against UI-1/UI-2 sequencing in [EEMO_REVENUE_ARCHITECTURE.md](EEMO_REVENUE_ARCHITECTURE.md) and formalized in the migration plan.
