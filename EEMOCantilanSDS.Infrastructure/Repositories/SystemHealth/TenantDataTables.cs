...
public static class TenantDataTables
{
    ...
    {
        "Facilities", "FacilityRates", "FacilitySectionRates", "FacilitySectionUtilities", "FacilitySectionClosures", "OrSeriesConfigs", "RevenueClassifications", "RevenueClassificationPolicies", "Stalls", "Contracts", "PaymentRecords",
