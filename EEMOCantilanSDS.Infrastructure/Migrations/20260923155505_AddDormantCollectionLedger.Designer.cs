...
namespace EEMOCantilanSDS.Infrastructure.Migrations
{
    ...
    [Migration("20260923155505_AddDormantCollectionLedger")]
    partial class AddDormantCollectionLedger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Facilities.Facility", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("CustomSectionNames")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                    ...
                    b.Property<string>("FishSectionLabel")
                        .HasMaxLength(60)
                    ...
                    b.Property<string>("MeatSectionLabel")
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)");

                    b.Property<int>("MonthBasis")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);

                    b.Property<DateTime?>("MonthBasisStatedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("VegetableSectionLabel")
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)");
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Facilities.FacilitySectionClosure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<Guid>>("ClosedStallIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid[]")
                    ...
                    b.HasIndex("MunicipalityId", "FacilityCode", "SectionName")
                        .IsUnique();

                    b.ToTable("FacilitySectionClosures", (string)null);
                });

            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Facilities.FacilitySectionRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MunicipalityId", "FacilityCode", "SectionName", "EffectiveDate")
                        .IsUnique();

                    b.ToTable("FacilitySectionRates", (string)null);
                });

            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Facilities.FacilitySectionUtilities", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FacilitySectionUtilities", (string)null);
                });
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Facilities.Stall", b =>
                {
                    ...
                    b.Property<string>("CustomSectionName")
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)");
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Notifications.CollectorDeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CollectorDeviceTokens", (string)null);
                });

            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Onboarding.AssessmentRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ApproxVendors")
                        .HasMaxLength(60)
                        .HasColumnType("character varying(60)");
                    ...
                    b.Property<string>("FacilitiesManaged")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("OnboardingLink")
                        .HasMaxLength(300)
                    ...
                    b.Property<string>("RequestingOffice")
                        .IsRequired()
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Onboarding.OnboardingDraft", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsSubmittedForValidation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Payments.OnlinePaymentTransaction", b =>
                {
                    ...
                    b.Property<decimal?>("DeclaredFishKilos")
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<string>("FishDayDeclarations")
                        .HasMaxLength(400)
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Revenue.CollectionLine", b =>
                {
                    ...
                    b.ToTable("CollectionLines", null, t =>
                        {
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Revenue.RevenueClassification", b =>
                {
                    ...
                    b.HasIndex("MunicipalityId", "SemanticCode")
                        .IsUnique();

                    b.ToTable("RevenueClassifications", (string)null);
                });
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Revenue.RevenueClassificationPolicy", b =>
                {
                    ...
                    b.Property<int?>("PermittedInstrumentType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Slaughterhouse.SlaughterAnimalLabel", b =>
                {
                    ...
                    b.HasIndex("MunicipalityId", "AnimalType")
                        .IsUnique();

                    b.ToTable("SlaughterAnimalLabels", (string)null);
                });

            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Slaughterhouse.SlaughterAnimalRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MunicipalityId", "AnimalName")
                        .IsUnique();

                    b.ToTable("SlaughterAnimalRates", (string)null);
                });
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Suggestions.HiddenSuggestion", b =>
                {
                    ...
                    b.HasIndex("MunicipalityId", "Type", "Value")
                        .IsUnique();
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.TaboanMarket.TpmMarketDaySchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TpmMarketDaySchedules", (string)null);
                });
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Tenancy.Municipality", b =>
                {
                    ...
                    b.Property<string>("MobileBindToken")
                        .HasMaxLength(64)
                    ...
                    b.Property<DateTime?>("PayMongoLastVerifiedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("PayMongoPublicKey")
                        .HasColumnType("text");

                    b.Property<string>("PayMongoSecretKeyEnc")
                        .HasColumnType("text");

                    b.Property<string>("PayMongoWebhookId")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");

                    b.Property<string>("PayMongoWebhookSecretEnc")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ReportSignatories")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Tenancy.OrSeriesConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OrSeriesConfigs", (string)null);
                });

            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Tenancy.TenantBackup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MunicipalityId", "CreatedAtUtc");

                    b.ToTable("TenantBackups", (string)null);
                });
            ...
            modelBuilder.Entity("EEMOCantilanSDS.Domain.Entities.Users.BaseUser", b =>
                {
                    ...
                    b.Property<DateTime?>("MfaChallengeTokenExpiry")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("MfaReminderShownAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("MfaSecretCipher")
                        .HasColumnType("text");
